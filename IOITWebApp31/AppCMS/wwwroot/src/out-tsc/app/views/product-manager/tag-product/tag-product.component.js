...
exports.TagProductComponent = void 0;
...
var TagProductComponent = /** @class */ (function () {
    function TagProductComponent(http, modalDialogService, viewRef, toastr, common) {
        this.http = http;
        ...
        this.paging.query = "TargetType=2";
    ...
    TagProductComponent.prototype.ngOnInit = function () {
        this.GetListTags();
    };
    TagProductComponent.prototype.GetListTags = function () {
        var _this = this;
    ...
    //Chuyển trang
    TagProductComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListTags();
    };
    //Thông báo
    TagProductComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    TagProductComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    TagProductComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    TagProductComponent.prototype.QueryChanged = function () {
        var query = 'TargetType=2';
    ...
    TagProductComponent.prototype.OpenModalTag = function (item) {
        this.Item = new model_1.Tag();
        if (item != undefined) {
    ...
    TagProductComponent.prototype.ChangeTitle = function () {
        this.Item.Url = this.common.ConvertUrl(this.Item.Name);
    };
    // cập nhật 
    TagProductComponent.prototype.SaveTag = function () {
        var _this = this;
    ...
    //Popup xác nhận xóa
    TagProductComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
    ...
    TagProductComponent.prototype.ShowHide = function (id, i) {
        var _this = this;
    ...
    TagProductComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    TagProductComponent.prototype.GetClassSortTable = function (str) {
    ...
    TagProductComponent.prototype.CheckActionTable = function (TagId) {
        if (TagId == undefined) {
    ...
    TagProductComponent.prototype.ActionTableFunc = function () {
        var _this = this;
    ...
    ], TagProductComponent.prototype, "TagModal", void 0);
    TagProductComponent = __decorate([
        core_1.Component({
            selector: 'app-tag-product',
            templateUrl: './tag-product.component.html',
            styleUrls: ['./tag-product.component.scss']
        }),
    ...
    return TagProductComponent;
}());
exports.TagProductComponent = TagProductComponent;
//# sourceMappingURL=tag-product.component.js.map