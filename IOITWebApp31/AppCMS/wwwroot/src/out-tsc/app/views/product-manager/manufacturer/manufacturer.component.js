...
exports.ManufacturerComponent = void 0;
...
var ManufacturerComponent = /** @class */ (function () {
    ...
    ManufacturerComponent.prototype.CheckActionTable = function (ManufacturerId) {
        if (ManufacturerId == undefined) {
            var CheckAll_1 = this.CheckAll;
            this.listManufacturer.forEach(function (item) {
                item.Action = CheckAll_1;
            });
        }
        else {
            var CheckAll = true;
            for (var i = 0; i < this.listManufacturer.length; i++) {
                if (!this.listManufacturer[i].Action) {
                    CheckAll = false;
                    break;
                }
            }
    ...
    ManufacturerComponent.prototype.ActionTableFunc = function () {
        var _this = this;
