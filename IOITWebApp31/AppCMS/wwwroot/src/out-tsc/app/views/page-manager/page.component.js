...
var PageComponent = /** @class */ (function () {
    function PageComponent(http, modalDialogService, viewRef, toastr, common, callCategoryFunctionService, elm, router) {
        ...
        this.listFullCate = [];
        this.listTemplate = const_1.listTemplate;
        ...
        this.subscription = this.callCategoryFunctionService.getAction().subscribe(function (action) {
            if (action.TypeAction == 1) {
                _this.OpenCatePageModal(undefined, action.CategoryId, 2);
            }
            else if (action.TypeAction == 2) {
                _this.OpenCatePageModal(action.CategoryId, undefined, 3);
            }
            else if (action.TypeAction == 3) {
                _this.ShowConfirmDelete(action.CategoryId);
            }
            else if (action.TypeAction == 5) {
                _this.OpenCatePageModal(action.CategoryId, undefined, 5); // thêm danh mục vs ngôn ngữ mới
            }
            else if (action.TypeAction == 6) {
                _this.OpenCatePageModal(action.CategoryId, undefined, 6); // sửa danh mục vs ngôn ngữ mới
            }
    ...
    PageComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    PageComponent.prototype.upload = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
        ...
        this.http.request(uploadReq).subscribe(function (event) {
            if (event.type === http_1.HttpEventType.UploadProgress) {
                ...
                _this.Item.Image = event.body["data"].toString();
            }
        });
    };
    ...
    PageComponent.prototype.GetListCatePageParent = function (Id) {
        var _this = this;
        this.http.get('/api/category/GetByTree?arr=6&arr=7&arr=8&arr=9&arr=10&langId=' + this.Item.LanguageId, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    PageComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    PageComponent.prototype.selectLanguage = function () {
    ...
    PageComponent.prototype.QueryChanged = function () {
        ...
        var query = "arr=6&arr=7&arr=8&arr=9&arr=10";
    ...
    //Mở modal thêm mới
    PageComponent.prototype.OpenCatePageModal = function (CategoryId, CategoryParentId, type) {
        this.Item = new model_1.Category();
        this.Item.Contents = "";
    ...
    PageComponent.prototype.ShowHide = function (id, IsShow) {
        var _this = this;
        var stt = IsShow ? 1 : 10;
    ...
    PageComponent.prototype.GetListFullCate = function () {
        var _this = this;
    ...
    PageComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    PageComponent.prototype.OpenMediaModal = function () {
        this.OpenMediaFile.show();
    };
    PageComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    PageComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    PageComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    PageComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    PageComponent.prototype.RemoveImageAvatar = function () {
        this.Item.Image = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    PageComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    PageComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    PageComponent.prototype.SeclectMedia = function (item) {
    ...
    __decorate([
        ...
        __metadata("design:type", modal_1.ModalDirective)
    ], PageComponent.prototype, "OpenMediaFile", void 0);
