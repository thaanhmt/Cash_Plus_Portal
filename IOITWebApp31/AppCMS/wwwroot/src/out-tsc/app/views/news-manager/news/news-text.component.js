...
exports.NewsTextComponent = exports.MY_CUSTOM_FORMATS = void 0;
...
var NewsTextComponent = /** @class */ (function () {
    function NewsTextComponent(http, modalDialogService, viewRef, toastr, datePipe, common) {
        ...
        this.listHotNews = const_1.NewsStatus;
        this.tags = [];
        this.activeD = false;
        this.activeU = false;
    ...
    NewsTextComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.GetListAllProduct = function () {
        var _this = this;
    ...
    //Danh sách tags
    NewsTextComponent.prototype.GetListTag = function (obj) {
        var _this = this;
    ...
    // get category all
    NewsTextComponent.prototype.GetListCatnew = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.GetListNewsNote = function (newsId) {
        var _this = this;
    ...
    NewsTextComponent.prototype.getPostsTrack = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.GetListAuthor = function () {
        var _this = this;
        var query = "Type=1";
    ...
    NewsTextComponent.prototype.GetListUser = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.GetListLanguage = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    NewsTextComponent.prototype.SelectTypeNews = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    NewsTextComponent.prototype.SelectLanguage = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    ...
    //
    NewsTextComponent.prototype.StatusChanged = function (status) {
        var query = "1=1";
        if (this.q.txtSearch != undefined && this.q.txtSearch != '') {
            query += ' and Title.Contains("' + this.q.txtSearch + '")';
        }
    ...
    NewsTextComponent.prototype.CheckCategory = function (CategoryId, curItem) {
    ...
    // chon tin lien quan
    NewsTextComponent.prototype.SelectListNew = function (id) {
        console.log(this.listSuggestNews);
        console.log(id);
    };
    NewsTextComponent.prototype.onAttachChanged = function (value) {
    ...
    //Mở modal thêm mới
    NewsTextComponent.prototype.OpenNewsModal = function (item, type) {
        this.Item = new model_1.News();
        this.Item.Status = 1;
    ...
    NewsTextComponent.prototype.SaveDraft = function () {
        var _this = this;
        if (this.Item.TypeNewsId == undefined) {
            this.toastWarning("Chưa chọn Loại tin!");
            return;
    ...
    NewsTextComponent.prototype.DeleteNews = function (Id) {
        ...
        this.http.delete('/api/news/DeleteNewsPublic/' + Id + '/4', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.GetListNews();
                _this.viewRef.clear();
    ...
    NewsTextComponent.prototype.ShowConfirmDeleteNote = function (item) {
        var _this = this;
        if (this.activeU == true && this.activeD == false) {
            this.modalDialogService.openDialog(this.viewRef, {
                title: 'Xác nhận',
    ...
    NewsTextComponent.prototype.DeleteNewsNote = function (item) {
        var _this = this;
        //if (this.RoleCode == 'ADMIN') {
        //  if (this.activeU == true) {
    ...
    NewsTextComponent.prototype.upload2 = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    NewsTextComponent.prototype.RemoveUpFile = function () {
    ...
    NewsTextComponent.prototype.uploadVideo = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsTextComponent.prototype.RemoveVideo = function () {
        this.Item.LinkVideo = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    NewsTextComponent.prototype.ConfirmShowHide = function (item, i) {
        var _this = this;
    ...
    NewsTextComponent.prototype.ShowHide = function (id, i, isAll) {
        var _this = this;
        var stt = this.listNews[i].IsShow ? 1 : 10;
    ...
    NewsTextComponent.prototype.GetClassSortTablePublic = function (str) {
        if (this.paging.order_by != (str + " Desc") && this.paging.order_by != (str + " Asc")) {
            return "sorting";
        }
        else {
    ...
    NewsTextComponent.prototype.CheckActionTable = function (NewsId) {
        if (NewsId == undefined) {
    ...
    NewsTextComponent.prototype.ActionTableFunc = function () {
        var _this = this;
        if (this.RoleCode == 'ADMIN') {
    ...
    NewsTextComponent.prototype.ChangeLinkDetailNews = function (TypeNewsId, Url, NewsId) {
        return this.staticDomain + this.listTypeNews.filter(function (x) { return x.Id == TypeNewsId; })[0].ConstUrl + "/" + Url + "-" + NewsId + ".html";
    };
    NewsTextComponent.prototype.OpenModalTag = function () {
        this.Tag = new model_1.Tag();
        this.TagModal.show();
    };
    NewsTextComponent.prototype.SaveTag = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.ChangeTitleTag = function () {
        this.Tag.Url = this.common.ConvertUrl(this.Tag.Name);
    };
    NewsTextComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    NewsTextComponent.prototype.ShowConfirmStatus = function (id, status) {
        var _this = this;
    ...
    NewsTextComponent.prototype.SendStatus = function (id, status) {
        var _this = this;
        this.http.put('/api/news/ShowHide/' + id + "/" + status + "/0", undefined, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                if (status == 1)
                    _this.toastSuccess("Bài viết đã được xuất bản thành công!");
                else
                    _this.toastSuccess("Bài viết đã được gỡ xuất bản thành công!");
                _this.GetListNews();
                _this.NewsModal.hide();
                _this.viewRef.clear();
            }
    ...
    NewsTextComponent.prototype.OpenModalConfigDate = function (item) {
        this.Item = new model_1.News();
        this.Item.Contents = "";
        this.listLanguageTemp = this.listLanguage;
        this.Item.LanguageId = this.languageId;
    ...
    NewsTextComponent.prototype.changeTotalPrice = function () {
    ...
    NewsTextComponent.prototype.SaveNoteNews = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.ExportExcel = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.OpenMediaModal = function (type) {
        this.typeMedia = type;
        this.OpenMediaFile.show();
    };
    NewsTextComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    NewsTextComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    NewsTextComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    NewsTextComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsTextComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    NewsTextComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    NewsTextComponent.prototype.SeclectMedia = function (item) {
        if (this.typeMedia == 1)
    ...
    __decorate([
        ...
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsTextComponent.prototype, "TagModal", void 0);
    __decorate([
        core_1.ViewChild('ConfigDateModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsTextComponent.prototype, "ConfigDateModal", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", core_1.ElementRef)
    ], NewsTextComponent.prototype, "filevideo", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFile'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsTextComponent.prototype, "OpenMediaFile", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFileVideo'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsTextComponent.prototype, "OpenMediaFileVideo", void 0);
    __decorate([
        core_1.ViewChild('dateStart'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsTextComponent.prototype, "dateStart", void 0);
    __decorate([
        core_1.ViewChild('dateEnd'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsTextComponent.prototype, "dateEnd", void 0);
