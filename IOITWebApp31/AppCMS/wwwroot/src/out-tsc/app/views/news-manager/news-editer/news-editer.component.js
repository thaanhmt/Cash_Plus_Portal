...
exports.NewsEditerComponent = exports.MY_CUSTOM_FORMATS = void 0;
...
var NewsEditerComponent = /** @class */ (function () {
    function NewsEditerComponent(http, modalDialogService, viewRef, toastr, datePipe, common) {
        this.http = http;
        ...
        this.paging.order_by = "EditingAt Desc";
        ...
        //
        this.CheckRoleAp = new dt_1.CheckRole();
        var codeAp = "NB";
        this.CheckRoleAp.View = this.common.CheckAccessKeyRole(localStorage.getItem("access_key"), codeAp, 0);
        this.CheckRoleAp.Create = this.common.CheckAccessKeyRole(localStorage.getItem("access_key"), codeAp, 1);
        this.CheckRoleAp.Update = this.common.CheckAccessKeyRole(localStorage.getItem("access_key"), codeAp, 2);
        this.CheckRoleAp.Delete = this.common.CheckAccessKeyRole(localStorage.getItem("access_key"), codeAp, 3);
    }
    NewsEditerComponent.prototype.ngOnInit = function () {
        this.RoleCode = localStorage.getItem("roleCode");
        this.NameAuthor = localStorage.getItem("fullName");
        this.ckeConfig = {
        ...
        this.paging.query = "1=1 AND (Status=13 OR Status= 14 OR Status=15)";
    ...
    NewsEditerComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListAllProduct = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListAllNews = function () {
        var _this = this;
        var query = "LanguageId=" + this.Item.LanguageId;
        ...
        this.http.get('/api/news/GetByPage?page=1&page_size=200&query=' + query, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    //Danh sách tags
    NewsEditerComponent.prototype.GetListTag = function (obj) {
        var _this = this;
    ...
    // get category all
    NewsEditerComponent.prototype.GetListCatnew = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListNews = function () {
        var _this = this;
        ...
        this.http.post('/api/news/GetByPageCash', data, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                ...
                _this.total1 = res["metadata"].Editing;
                _this.total2 = res["metadata"].Edited;
                _this.total3 = res["metadata"].ReEdited;
        ...
        //      this.total1 = res["metadata"].Editing;
        //      this.total2 = res["metadata"].Edited;
        //      this.total3 = res["metadata"].ReEdited;
    ...
    NewsEditerComponent.prototype.GetListNewsNote = function (newsId) {
        var _this = this;
    ...
    NewsEditerComponent.prototype.getPostsTrack = function () {
        var _this = this;
    ...
    //    );
    //}
    NewsEditerComponent.prototype.GetListCateNews = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListOrderBy = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListAuthor = function () {
        var _this = this;
        var query = "Type=1";
    ...
    NewsEditerComponent.prototype.GetListUser = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetListLanguage = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    NewsEditerComponent.prototype.OpenChooseHighlightsNews = function () {
        this.listOrderByProduct = [];
        this.GetListOrderBy();
        this.HighlightNewsModal.show();
    };
    NewsEditerComponent.prototype.SaveHighlightNews = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.DeleteOrderBy = function (item) {
    ...
    NewsEditerComponent.prototype.SelectTypeNews = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    NewsEditerComponent.prototype.SelectLanguage = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    //Chuyển trang
    NewsEditerComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListNews();
    };
    //Thông báo
    NewsEditerComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    NewsEditerComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    NewsEditerComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //
    NewsEditerComponent.prototype.QueryChanged = function () {
        var query = "1=1 AND (Status=13 OR Status=14 OR Status=15)";
    ...
    //
    NewsEditerComponent.prototype.StatusChanged = function (status) {
        var query = "1=1";
        if (this.q.txtSearch != undefined && this.q.txtSearch != '') {
            query += ' and Title.Contains("' + this.q.txtSearch + '")';
        }
    ...
    NewsEditerComponent.prototype.CheckCategory = function (CategoryId, curItem) {
    ...
    // chon tin lien quan
    NewsEditerComponent.prototype.SelectListNew = function (id) {
        console.log(this.listSuggestNews);
        console.log(id);
    };
    NewsEditerComponent.prototype.onAttachChanged = function (value) {
    ...
    //Mở modal thêm mới
    NewsEditerComponent.prototype.OpenNewsModal = function (item, type) {
        /*console.log(item);*/
    ...
    NewsEditerComponent.prototype.SaveNews = function (status) {
        var _this = this;
    ...
    NewsEditerComponent.prototype.SaveDraft = function () {
        var _this = this;
        if (this.Item.TypeNewsId == undefined) {
            this.toastWarning("Chưa chọn Loại tin!");
            return;
    ...
    NewsEditerComponent.prototype.ToggleCateToList = function (id) {
        this.listNewsT = [];
    ...
    //     }
    // }
    NewsEditerComponent.prototype.ChangeTitle = function (key) {
        if (this.Item.NewsId == undefined) {
            switch (key) {
                case 1:
    ...
    //Popup xác nhận xóa
    NewsEditerComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
    ...
    NewsEditerComponent.prototype.DeleteNews = function (Id) {
        var _this = this;
        //if (this.RoleCode == 'ADMIN') {
        //  if (this.activeU == true) {
        this.http.delete('/api/news/DeleteNewsPublic/' + Id + '/2', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.GetListNews();
                _this.viewRef.clear();
    ...
    NewsEditerComponent.prototype.ShowConfirmDeleteNote = function (item) {
        var _this = this;
        if (this.activeU == true && this.activeD == false) {
            this.modalDialogService.openDialog(this.viewRef, {
                title: 'Xác nhận',
    ...
    NewsEditerComponent.prototype.DeleteNewsNote = function (item) {
        var _this = this;
        //if (this.RoleCode == 'ADMIN') {
        //  if (this.activeU == true) {
    ...
    NewsEditerComponent.prototype.upload2 = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    NewsEditerComponent.prototype.RemoveUpFile = function () {
        this.Item.LinkVideo = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    NewsEditerComponent.prototype.upload = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsEditerComponent.prototype.uploadVideo = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsEditerComponent.prototype.findAuthor = function (item) {
        if (item == undefined) {
            return "";
        }
        else {
    ...
    NewsEditerComponent.prototype.RemoveImage = function () {
        this.Item.Image = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    NewsEditerComponent.prototype.ConfirmShowHide = function (item, i) {
        var _this = this;
        /*if (item.listLanguage.length > 0) {*/
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
            data: {
                text: "Bạn có muốn gửi kiểm duyệt bài viết?"
            },
            actionButtons: [
                {
                    text: 'Đồng ý',
    ...
    NewsEditerComponent.prototype.ShowHide = function (id, i, isAll) {
        var _this = this;
        var stt = 16;
        this.http.put('/api/news/ShowHide/' + id + "/" + stt + "/" + isAll, undefined, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                if (stt == 1) {
                    ...
                    _this.toastSuccess("Bài viết đã được gửi kiểm duyệt!");
                }
                else {
    ...
    NewsEditerComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    NewsEditerComponent.prototype.GetClassSortTable = function (str) {
    ...
    NewsEditerComponent.prototype.RemoveAttachment = function (idx) {
    ...
    NewsEditerComponent.prototype.SetIsMain = function (idx) {
    ...
    NewsEditerComponent.prototype.CheckActionTable = function (NewsId) {
        if (NewsId == undefined) {
    ...
    NewsEditerComponent.prototype.ActionTableFunc = function () {
        var _this = this;
        if (this.RoleCode == 'ADMIN') {
    ...
    NewsEditerComponent.prototype.ChangeLinkDetailNews = function (TypeNewsId, Url, NewsId) {
        return const_1.domain + this.listTypeNews.filter(function (x) { return x.Id == TypeNewsId; })[0].ConstUrl + "/" + Url + "-" + NewsId + ".html";
    };
    NewsEditerComponent.prototype.OpenModalTag = function () {
        this.Tag = new model_1.Tag();
        this.TagModal.show();
    };
    NewsEditerComponent.prototype.SaveTag = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.ChangeTitleTag = function () {
        this.Tag.Url = this.common.ConvertUrl(this.Tag.Name);
    };
    NewsEditerComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    NewsEditerComponent.prototype.ShowConfirmStatus = function (id, status) {
        var _this = this;
        var title = "Bạn có chắc chắn muốn gửi kiểm duyệt bài viết này?";
        if (status == 12)
            title = "Bạn có chắc chắn muốn trả lại bài viết cho PV/CTV?";
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
            data: {
    ...
    NewsEditerComponent.prototype.SendStatus = function (id, status) {
        var _this = this;
        this.http.put('/api/news/ShowHide/' + id + "/" + status + "/0", undefined, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                if (status != 12)
                    _this.toastSuccess("Bài viết đã được gửi kiểm duyệt thành công!");
                else
                    _this.toastSuccess("Bài viết đã được gửi trả lại cho PV/CTV thành công!");
                _this.GetListNews();
                _this.viewRef.clear();
            }
            else {
    ...
    NewsEditerComponent.prototype.changeTotalPrice = function () {
    ...
    NewsEditerComponent.prototype.SaveNoteNews = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.ExportExcel = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.OpenMediaModal = function (type) {
        this.typeMedia = type;
        this.OpenMediaFile.show();
    };
    NewsEditerComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    NewsEditerComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    NewsEditerComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    NewsEditerComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsEditerComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    NewsEditerComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    NewsEditerComponent.prototype.SeclectMedia = function (item) {
        if (this.typeMedia == 1)
    ...
    ], NewsEditerComponent.prototype, "NewsModal", void 0);
    __decorate([
        core_1.ViewChild('HighlightNewsModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsEditerComponent.prototype, "HighlightNewsModal", void 0);
    __decorate([
        core_1.ViewChild('TagModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsEditerComponent.prototype, "TagModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsEditerComponent.prototype, "file", void 0);
    __decorate([
        core_1.ViewChild('filevideo'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsEditerComponent.prototype, "filevideo", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFile'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsEditerComponent.prototype, "OpenMediaFile", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFileVideo'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsEditerComponent.prototype, "OpenMediaFileVideo", void 0);
    __decorate([
        core_1.ViewChild('attachment'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsEditerComponent.prototype, "attachment", void 0);
    __decorate([
        core_1.ViewChild('tabset'),
        __metadata("design:type", tabs_1.TabsetComponent)
    ], NewsEditerComponent.prototype, "tabset", void 0);
    __decorate([
        core_1.ViewChild('dateStart'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsEditerComponent.prototype, "dateStart", void 0);
    __decorate([
        core_1.ViewChild('dateEnd'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsEditerComponent.prototype, "dateEnd", void 0);
    NewsEditerComponent = __decorate([
        core_1.Component({
            selector: 'app-news-editer',
            templateUrl: './news-editer.component.html',
            styleUrls: ['./news-editer.component.scss'],
            providers: [
    ...
    return NewsEditerComponent;
}());
exports.NewsEditerComponent = NewsEditerComponent;
//# sourceMappingURL=news-editer.component.js.map