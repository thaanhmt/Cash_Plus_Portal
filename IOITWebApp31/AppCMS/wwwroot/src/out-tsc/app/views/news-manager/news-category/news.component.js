...
var NewsComponent = /** @class */ (function () {
    ...
    NewsComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    NewsComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    NewsComponent.prototype.selectLanguage = function () {
    ...
    //Mở modal thêm mới
    NewsComponent.prototype.OpenCateNewsModal = function (CategoryId, CategoryParentId, type) {
    ...
    NewsComponent.prototype.RemoveImage = function () {
        /*if (Type == 5) {*/
        this.file.nativeElement.value = "";
    ...
    NewsComponent.prototype.ShowHide = function (id, IsShow) {
        var _this = this;
        var stt = IsShow ? 1 : 10;
    ...
    NewsComponent.prototype.GetListFullCate = function () {
        var _this = this;
    ...
    NewsComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    NewsComponent.prototype.OpenMediaModal = function () {
        this.OpenMediaFile.show();
    };
    NewsComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    NewsComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    NewsComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    NewsComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    NewsComponent.prototype.SeclectMedia = function (item) {
    ...
    __decorate([
        ...
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsComponent.prototype, "OpenMediaFile", void 0);
