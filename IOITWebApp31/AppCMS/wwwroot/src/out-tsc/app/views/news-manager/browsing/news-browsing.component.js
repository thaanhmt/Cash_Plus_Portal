...
exports.NewsBrowsingComponent = exports.MY_CUSTOM_FORMATS = void 0;
...
var NewsBrowsingComponent = /** @class */ (function () {
    function NewsBrowsingComponent(http, modalDialogService, viewRef, toastr, datePipe, common) {
        this.http = http;
        ...
        this.q.txtSearch = "";
        this.IsAll = false;
        this.CheckConfirmNews = this.common.CheckAccessKey(localStorage.getItem("access_key"), "DBBTV") && (this.RoleCode == 'BTV' || this.RoleCode == 'ADMIN' || this.RoleCode == 'TKTC');
    ...
    NewsBrowsingComponent.prototype.ngOnInit = function () {
        this.ckeConfig = {
        ...
        this.paging.query = "1=1 AND (Status=16 OR Status=17)";
        this.GetListCatnew();
        this.GetListNews();
        this.GetListUser();
        this.GetListAuthor();
    ...
    NewsBrowsingComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListAllProduct = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListAllNews = function () {
        var _this = this;
        var query = "LanguageId=" + this.Item.LanguageId;
        ...
        // if (this.Item.TypeNewsId == 6) {
        //     if (this.Item.LanguageId == 1007) {
        //         query += " and CategoryId=4274";
        //     }
        //     else {
        //         query += " and CategoryId=4094";
        //     }
        // }
        this.http.get('/api/news/GetByPage/?page=1&query=' + query + '&order_by=&select=NewsId,Title,Url,Image,TypeNewsId,LanguageId', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    //Danh sách tags
    NewsBrowsingComponent.prototype.GetListTag = function (obj) {
        var _this = this;
    ...
    // get category all
    NewsBrowsingComponent.prototype.GetListCatnew = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListNews = function () {
        var _this = this;
        ...
        this.http.post('/api/news/GetByPageCash', data, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                ...
                _this.total1 = res["metadata"].Approving;
                _this.total2 = res["metadata"].NotApproved;
        ...
        //      //  item.IsPublic = item.Status == 1 ? true : false;
        //      //});
        //      this.paging.item_count = res["metadata"].Sum;
        //      this.total1 = res["metadata"].Approving;
        //      this.total2 = res["metadata"].NotApproved;
        //      //this.total3 = res["metadata"].ReNew;
    ...
    NewsBrowsingComponent.prototype.GetListNewsNote = function (newsId) {
        var _this = this;
    ...
    //    );
    //}
    NewsBrowsingComponent.prototype.GetListCateNews = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListOrderBy = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListAuthor = function () {
        var _this = this;
        var query = "Type=1";
    ...
    NewsBrowsingComponent.prototype.GetListUser = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetListLanguage = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.OpenChooseHighlightsNews = function () {
        this.listOrderByProduct = [];
        this.GetListOrderBy();
        this.HighlightNewsModal.show();
    };
    NewsBrowsingComponent.prototype.SaveHighlightNews = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.DeleteOrderBy = function (item) {
    ...
    NewsBrowsingComponent.prototype.SelectTypeNews = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    NewsBrowsingComponent.prototype.SelectLanguage = function () {
        this.GetListCateNews();
        this.GetListAllNews();
        this.GetListAllProduct();
    };
    //Chuyển trang
    NewsBrowsingComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListNews();
    };
    //Thông báo
    NewsBrowsingComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    NewsBrowsingComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    NewsBrowsingComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //
    NewsBrowsingComponent.prototype.QueryChanged = function () {
        var query = "1=1 AND (Status=16 || Status=17)";
    ...
    NewsBrowsingComponent.prototype.StatusChanged = function (status) {
        var query = "1=1";
        if (this.q.txtSearch != undefined && this.q.txtSearch != '') {
            query += ' and Title.Contains("' + this.q.txtSearch + '")';
        }
    ...
    NewsBrowsingComponent.prototype.CheckCategory = function (CategoryId, curItem) {
    ...
    // chon tin lien quan
    NewsBrowsingComponent.prototype.SelectListNew = function (id) {
        console.log(this.listSuggestNews);
        console.log(id);
    };
    NewsBrowsingComponent.prototype.onAttachChanged = function (value) {
    ...
    //Mở modal thêm mới
    NewsBrowsingComponent.prototype.OpenNewsModal = function (item, type) {
        this.Item = new model_1.News();
        this.Item.Contents = "";
    ...
    //Thêm mới bài viết
    NewsBrowsingComponent.prototype.SaveNews = function (status) {
        var _this = this;
        ...
        if (this.Item.NewsId == undefined) {
            ...
            this.http.post('/api/news', obj, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    ...
                    _this.toastError(res["meta"]["error_code"] == 228);
                }
            }, function (err) {
                _this.toastError("Đã xảy ra lỗi. Xin vui lòng thử lại sau!");
            });
    ...
    NewsBrowsingComponent.prototype.SaveDraft = function () {
        var _this = this;
        if (this.Item.TypeNewsId == undefined) {
            this.toastWarning("Chưa chọn Loại tin!");
            return;
    ...
    NewsBrowsingComponent.prototype.ToggleCateToList = function (id) {
        this.listNewsT = [];
        for (var i = 0; i < this.listCateNews.length; i++) {
    ...
    //     }
    // }
    NewsBrowsingComponent.prototype.ChangeTitle = function (key) {
        if (this.Item.NewsId == undefined) {
            switch (key) {
                case 1:
    ...
    //Popup xác nhận xóa
    NewsBrowsingComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.DeleteNews = function (Id) {
        var _this = this;
        this.http.delete('/api/news/' + Id + '/3', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.GetListNews();
                _this.viewRef.clear();
    ...
    NewsBrowsingComponent.prototype.upload2 = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    NewsBrowsingComponent.prototype.RemoveUpFile = function () {
        this.Item.LinkVideo = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    NewsBrowsingComponent.prototype.upload = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsBrowsingComponent.prototype.uploadVideo = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsBrowsingComponent.prototype.findAuthor = function (item) {
        if (item == undefined) {
            return "";
        }
        else {
    ...
    NewsBrowsingComponent.prototype.RemoveImage = function () {
        this.Item.Image = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    NewsBrowsingComponent.prototype.ConfirmShowHideBrowsing = function (item, i) {
        var _this = this;
        if (item.listLanguage.length > 0) {
            this.modalDialogService.openDialog(this.viewRef, {
                title: 'Xác nhận',
                childComponent: ngx_modal_dialog_1.SimpleModalComponent,
                data: {
                    text: "Bạn có muốn thay đổi trạng thái các bài viết của các ngôn ngữ khác?"
                },
                actionButtons: [
                    {
                        text: 'Đồng ý',
                        buttonClass: 'btn btn-success',
                        onAction: function () {
                            _this.ShowHideBrowSing(item.NewsId, i, 1);
                        }
                    },
                    {
                        text: 'Không đồng ý',
                        ...
                        onAction: function () {
                            _this.ShowHideBrowSing(item.NewsId, i, 0);
                        }
                    }
                ],
            });
            ...
            this.ShowHideBrowSing(item.NewsId, i, 0);
        }
    };
    NewsBrowsingComponent.prototype.ShowHideBrowSing = function (id, i, isAll) {
        var _this = this;
        if (this.CheckConfirmNews == true) {
            var stt_1 = this.listNews[i].IsShow ? 12 : 11;
            this.http.put('/api/news/ShowHide/' + id + "/" + stt_1 + "/" + isAll, undefined, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    if (stt_1 == 12) {
                        _this.toastSuccess("Bài viết đã được duyệt");
                    }
                    else {
                        _this.toastWarning("Bài viết đã chuyển về cho tác giả");
                    }
                    _this.GetListNews();
                    _this.viewRef.clear();
                }
    ...
    NewsBrowsingComponent.prototype.ConfirmShowHidePublic = function (item, i) {
        var _this = this;
        if (item.listLanguage.length > 0) {
            this.modalDialogService.openDialog(this.viewRef, {
                title: 'Xác nhận',
                ...
                actionButtons: [
                    {
                        ...
                        buttonClass: 'btn btn-success',
                        onAction: function () {
                            _this.ShowHidePublic(item.NewsId, i, 1);
                        }
                    },
                    {
                        text: 'Không đồng ý',
                        buttonClass: 'btn btn-default',
                        onAction: function () {
                            _this.ShowHidePublic(item.NewsId, i, 0);
                        }
                    }
                ],
            });
            ...
            this.ShowHidePublic(item.NewsId, i, 0);
        }
    };
    NewsBrowsingComponent.prototype.ShowHidePublic = function (id, i, isAll) {
        var _this = this;
        if (this.CheckConfirmNews == true) {
            var sttPublic = this.listNews[i].IsPublic ? 1 : 12;
            this.http.put('/api/news/ShowHide/' + id + "/" + sttPublic + "/" + isAll, undefined, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    ...
                    _this.toastError("Đã xảy ra lỗi. Xin vui lòng thử lại sau!");
                    _this.listNews[i].IsPublic = !_this.listNews[i].IsPublic;
                }
            }, function (err) {
                _this.toastError("Đã xảy ra lỗi. Xin vui lòng thử lại sau!");
                _this.listNews[i].IsPublic = !_this.listNews[i].IsPublic;
    ...
    NewsBrowsingComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    NewsBrowsingComponent.prototype.GetClassSortTable = function (str) {
    ...
    NewsBrowsingComponent.prototype.RemoveAttachment = function (idx) {
    ...
    NewsBrowsingComponent.prototype.SetIsMain = function (idx) {
    ...
    NewsBrowsingComponent.prototype.CheckActionTable = function (NewsId) {
        if (NewsId == undefined) {
    ...
    NewsBrowsingComponent.prototype.ActionTableFunc = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.ChangeLinkDetailNews = function (TypeNewsId, Url, NewsId) {
        return const_1.domain + this.listTypeNews.filter(function (x) { return x.Id == TypeNewsId; })[0].ConstUrl + "/" + Url + "-" + NewsId + ".html";
    };
    NewsBrowsingComponent.prototype.OpenModalTag = function () {
        this.Tag = new model_1.Tag();
        this.TagModal.show();
    };
    NewsBrowsingComponent.prototype.SaveTag = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.ChangeTitleTag = function () {
        this.Tag.Url = this.common.ConvertUrl(this.Tag.Name);
    };
    NewsBrowsingComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    NewsBrowsingComponent.prototype.ShowConfirmStatus = function (id, status) {
        var _this = this;
        var title = "Bạn có chắc chắn duyệt bài viết này?";
        if (status == 17)
            title = "Bạn có chắc chắn không duyệt bài viết này?";
        if (status == 15)
            title = "Bạn có chắc chắn trả lại bài viết này để biên tập lại?";
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
            data: {
    ...
    NewsBrowsingComponent.prototype.SendStatus = function (id, status) {
        var _this = this;
        this.http.put('/api/news/ShowHide/' + id + "/" + status + "/0", undefined, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                if (status == 18)
                    _this.toastSuccess("Bài viết đã được duyệt thành công!");
                else if (status == 17)
                    _this.toastSuccess("Bài viết đã không được duyệt thành công!");
                else if (status == 15)
                    _this.toastSuccess("Bài viết đã được trả biên tập lại thành công!");
                _this.GetListNews();
                _this.NewsModal.hide();
                _this.viewRef.clear();
            }
    ...
    NewsBrowsingComponent.prototype.changeTotalPrice = function () {
    ...
    NewsBrowsingComponent.prototype.SaveNoteNews = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.ExportExcel = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.OpenMediaModal = function (type) {
        this.typeMedia = type;
        this.OpenMediaFile.show();
    };
    NewsBrowsingComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    NewsBrowsingComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    NewsBrowsingComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    NewsBrowsingComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    NewsBrowsingComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    NewsBrowsingComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    NewsBrowsingComponent.prototype.SeclectMedia = function (item) {
        if (this.typeMedia == 1)
    ...
    ], NewsBrowsingComponent.prototype, "NewsModal", void 0);
    __decorate([
        core_1.ViewChild('HighlightNewsModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsBrowsingComponent.prototype, "HighlightNewsModal", void 0);
    __decorate([
        core_1.ViewChild('TagModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsBrowsingComponent.prototype, "TagModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsBrowsingComponent.prototype, "file", void 0);
    __decorate([
        core_1.ViewChild('attachment'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsBrowsingComponent.prototype, "attachment", void 0);
    __decorate([
        core_1.ViewChild('tabset'),
        __metadata("design:type", tabs_1.TabsetComponent)
    ], NewsBrowsingComponent.prototype, "tabset", void 0);
    __decorate([
        core_1.ViewChild('filevideo'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsBrowsingComponent.prototype, "filevideo", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFile'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsBrowsingComponent.prototype, "OpenMediaFile", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFileVideo'),
        __metadata("design:type", modal_1.ModalDirective)
    ], NewsBrowsingComponent.prototype, "OpenMediaFileVideo", void 0);
    __decorate([
        core_1.ViewChild('dateStart'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsBrowsingComponent.prototype, "dateStart", void 0);
    __decorate([
        core_1.ViewChild('dateEnd'),
        __metadata("design:type", core_1.ElementRef)
    ], NewsBrowsingComponent.prototype, "dateEnd", void 0);
    NewsBrowsingComponent = __decorate([
        core_1.Component({
            selector: 'app-news-retify',
            templateUrl: './news-browsing.component.html',
            styleUrls: ['./news-browsing.component.scss'],
            providers: [
    ...
    return NewsBrowsingComponent;
}());
exports.NewsBrowsingComponent = NewsBrowsingComponent;
//# sourceMappingURL=news-browsing.component.js.map