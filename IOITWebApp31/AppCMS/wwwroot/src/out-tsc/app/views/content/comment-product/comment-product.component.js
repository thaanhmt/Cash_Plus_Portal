...
exports.CommentProductComponent = exports.MY_CUSTOM_FORMATS = void 0;
...
var CommentProductComponent = /** @class */ (function () {
    function CommentProductComponent(http, modalDialogService, viewRef, toastr, datePipe, common) {
        this.http = http;
    ...
    CommentProductComponent.prototype.ngOnInit = function () {
    ...
    CommentProductComponent.prototype.GetListCommentPost = function () {
        var _this = this;
        this.page_pp = [];
        this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=TargetType=2&order_by=', this.httpOptions).subscribe(function (res) {
    ...
    CommentProductComponent.prototype.GetListCommentPostChoDuyet = function () {
        var _this = this;
        this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=1&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    //Danh sách tất cả bình luận cho duyet
    CommentProductComponent.prototype.GetListCommentPostDaDuyet = function () {
        var _this = this;
        this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=2&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    //Danh sách tất cả bình luận cho duyet
    CommentProductComponent.prototype.GetListCommentPostKhongDuyet = function () {
        var _this = this;
        this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=3&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    CommentProductComponent.prototype.GetListCommentPostSpam = function () {
        var _this = this;
        this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=4&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    CommentProductComponent.prototype.GetListCustomer = function () {
        var _this = this;
    ...
    CommentProductComponent.prototype.GetListNews = function () {
        var _this = this;
        this.http.get('/api/product/GetByPage?page=' + this.paging.page + '&query=' + this.paging.query + '&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    // Duyet binh luan
    CommentProductComponent.prototype.DuyetComment = function (item, id) {
        var _this = this;
    ...
    // Loc theo trang thai
    CommentProductComponent.prototype.ChangeStatust = function (id) {
        var _this = this;
        if (id == 0) {
            this.GetListCommentPost();
            this.GetListCustomer();
            ...
            this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status =' + id + '&order_by=', this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    _this.listCommentPost = res["data"];
                    _this.paging.item_count = res["metadata"];
                }
    ...
    CommentProductComponent.prototype.ActionTableFunc = function () {
        var _this = this;
    ...
    //Mở modal thêm mới
    CommentProductComponent.prototype.OpenCommentModal = function (item) {
        this.Item = new model_1.CommentPost();
    ...
    CommentProductComponent.prototype.OpenRepComment = function (item) {
        if (item != undefined) {
            this.Item = JSON.parse(JSON.stringify(item));
        }
    ...
    //Thêm mới
    CommentProductComponent.prototype.SaveCommnent = function () {
        var _this = this;
    ...
    CommentProductComponent.prototype.SaveCommnentChild = function () {
        var _this = this;
    ...
    //Chuyển trang
    CommentProductComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListCommentPost();
    };
    //Thông báo
    CommentProductComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    CommentProductComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    CommentProductComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //
    //Popup xác nhận xóa
    CommentProductComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
    ...
    CommentProductComponent.prototype.CheckAllAddress = function () {
        this.listId = [];
    ...
    //Chon binh luan xoa
    CommentProductComponent.prototype.CheckDeleteAddress = function (item) {
    ...
    //Xoa nhieu
    CommentProductComponent.prototype.DeleteMuntiAddress = function () {
        var _this = this;
    ...
    ], CommentProductComponent.prototype, "CommentModal", void 0);
    __decorate([
        core_1.ViewChild('RepComment'),
        __metadata("design:type", modal_1.ModalDirective)
    ], CommentProductComponent.prototype, "RepComment", void 0);
    CommentProductComponent = __decorate([
        core_1.Component({
    ...
    return CommentProductComponent;
}());
exports.CommentProductComponent = CommentProductComponent;
//# sourceMappingURL=comment-product.component.js.map