...
exports.ApplicationRangeComponent = void 0;
...
var ApplicationRangeComponent = /** @class */ (function () {
    function ApplicationRangeComponent(http, modalDialogService, viewRef, toastr, common, callCategoryFunctionService, elm, router) {
        var _this = this;
        this.http = http;
    ...
    ApplicationRangeComponent.prototype.ngOnInit = function () {
    ...
    ApplicationRangeComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
        this.router.onSameUrlNavigation = 'ignore';
    };
    //Get danh sách tin
    ApplicationRangeComponent.prototype.GetListCateNews = function () {
        var _this = this;
        this.listCateNews = [];
    ...
    ApplicationRangeComponent.prototype.QueryChanged = function () {
        var query = "arr=15";
    ...
    ApplicationRangeComponent.prototype.GetListLanguage = function () {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.GetTranslate = function (id) {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.GetListCateParent = function (Id) {
        var _this = this;
        this.http.get('/api/category/GetByTree?arr=15&langId=' + this.Item.LanguageId, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ApplicationRangeComponent.prototype.selectLanguage = function () {
        this.GetListCateParent(undefined);
    };
    //Thông báo
    ApplicationRangeComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    ApplicationRangeComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    ApplicationRangeComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //Mở modal thêm mới
    ApplicationRangeComponent.prototype.OpenCateNewsModal = function (CategoryId, CategoryParentId, type) {
        this.typeAction = type;
        this.Item = new model_1.Category();
        this.Item.Status = 1;
        this.Item.StatusView = true;
        this.Item.CategoryParentId = CategoryParentId;
        this.Item.TypeCategoryId = 15;
    ...
    ApplicationRangeComponent.prototype.SaveCateNews = function () {
        var _this = this;
        if (this.Item.Code == undefined || this.Item.Code == '') {
            this.toastWarning("Chưa nhập mã phạm vi ứng dụng!");
            return;
        }
            ...
            this.toastWarning("Chưa nhập tên phạm vi ứng dụng!");
            return;
        }
    ...
    ApplicationRangeComponent.prototype.ChangeTitle = function (key) {
    ...
    //Popup xác nhận xóa
    ApplicationRangeComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
            data: {
                text: "Bạn có chắc chắn muốn xóa phạm vi ứng dụng này?"
            },
            actionButtons: [
                {
                    text: 'Đồng ý',
    ...
    ApplicationRangeComponent.prototype.DeleteCateNews = function (Id) {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.findParent = function (item) {
        if (item == undefined) {
            return "";
        }
        else {
    ...
    ApplicationRangeComponent.prototype.upload = function (files, Type) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    ApplicationRangeComponent.prototype.RemoveImage = function (type) {
        if (type == 1) {
            this.file.nativeElement.value = "";
    ...
    ApplicationRangeComponent.prototype.ShowHide = function (id, IsShow) {
        var _this = this;
        var stt = IsShow ? 1 : 10;
    ...
    ApplicationRangeComponent.prototype.SaveSortCategory = function () {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.ResetCurrentRouter = function () {
    ...
    ApplicationRangeComponent.prototype.GetListFullCate = function () {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    ApplicationRangeComponent.prototype.OpenMediaModal = function (type) {
        this.typeSelect = type;
        this.OpenMediaFile.show();
    };
    ApplicationRangeComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    ApplicationRangeComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    ApplicationRangeComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    ApplicationRangeComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    ApplicationRangeComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    ApplicationRangeComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    ApplicationRangeComponent.prototype.SeclectMedia = function (item) {
        if (this.typeSelect == 1)
            this.Item.Image = item.url + "/" + item.name;
        else if (this.typeSelect == 2)
            this.Item.Icon = item.url + "/" + item.name;
        this.OpenMediaFile.hide();
    };
    __decorate([
        core_1.ViewChild('CateNewsModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], ApplicationRangeComponent.prototype, "CateNewsModal", void 0);
    __decorate([
        core_1.ViewChild('SortNewsModal'),
        __metadata("design:type", modal_1.ModalDirective)
    ], ApplicationRangeComponent.prototype, "SortNewsModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], ApplicationRangeComponent.prototype, "file", void 0);
    __decorate([
        core_1.ViewChild('OpenMediaFile'),
        __metadata("design:type", modal_1.ModalDirective)
    ], ApplicationRangeComponent.prototype, "OpenMediaFile", void 0);
    ApplicationRangeComponent = __decorate([
        core_1.Component({
            selector: 'app-application-range',
            templateUrl: './application-range.component.html',
            styleUrls: ['./application-range.component.scss']
        }),
    ...
    return ApplicationRangeComponent;
}());
exports.ApplicationRangeComponent = ApplicationRangeComponent;
//# sourceMappingURL=application-range.component.js.map