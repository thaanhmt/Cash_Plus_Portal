...
var SlideComponent = /** @class */ (function () {
    function SlideComponent(http, modalDialogService, viewRef, toastr, common) {
        this.http = http;
    ...
    SlideComponent.prototype.GetDomainStatic = function () {
        var _this = this;
    ...
    SlideComponent.prototype.GetListSlide = function () {
        var _this = this;
        this.http.get('/api/slide/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=' + this.paging.query + '&order_by=' + this.paging.order_by, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.listSlide = res["data"];
                _this.listSlide.forEach(function (item) {
    ...
    SlideComponent.prototype.GetListLanguage = function () {
        var _this = this;
        this.http.get('/api/Language/GetByPage?page=1&query=1=1&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                ...
                if (_this.listLanguage.length == 1 && (_this.Item.SlideId == undefined || (_this.Item.SlideId != undefined && _this.Item.LanguageId == undefined))) {
    ...
    //  );
    //}
    SlideComponent.prototype.GetListTypeSlide = function () {
        var _this = this;
        this.http.get('/api/typeSlide/GetByPage?page=1&query=1=1&order_by=', this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.listTypeSlides = res["data"];
            }
        }, function (err) {
            console.log("Error: connect to API");
        });
    ...
    //Mở modal thêm mới
    SlideComponent.prototype.OpenSlideModal = function (item) {
        this.Item = new model_1.Slide();
        this.Item.Status = 1;
    ...
    SlideComponent.prototype.SaveSlide = function () {
        var _this = this;
        ...
        if (this.Item.SlideId == undefined) {
            this.http.post('/api/slide', this.Item, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    _this.GetListSlide();
                    _this.SlideModal.hide();
            ...
            this.http.put('/api/slide/' + this.Item.SlideId, this.Item, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    _this.GetListSlide();
                    _this.SlideModal.hide();
    ...
    //Popup xác nhận xóa
    SlideComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
    ...
    SlideComponent.prototype.Delete = function (Id) {
        var _this = this;
        this.http.delete('/api/Slide/' + Id, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.GetListSlide();
                _this.viewRef.clear();
    ...
    SlideComponent.prototype.upload = function (files, IsNew) {
        var _this = this;
        if (files.length === 0)
            return;
        ...
        var uploadReq = new http_1.HttpRequest('POST', 'api/upload/uploadImage/3', formData, {
            headers: new http_1.HttpHeaders({
                'Authorization': 'bearer ' + localStorage.getItem("access_token")
            }),
            reportProgress: true,
    ...
    SlideComponent.prototype.ConfirmShowHide = function (item, i) {
        var _this = this;
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
    ...
    SlideComponent.prototype.ShowHide = function (item, i) {
        var _this = this;
        var stt = item.IsShow ? 1 : 10;
        this.http.put('/api/slide/ShowHide/' + item.SlideId + "/" + stt, undefined, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    SlideComponent.prototype.RemoveImage = function () {
    ...
    SlideComponent.prototype.CheckActionTable = function (SlideId) {
        if (SlideId == undefined) {
            var CheckAll_1 = this.CheckAll;
            this.listSlide.forEach(function (item) {
    ...
    SlideComponent.prototype.ActionTableFunc = function () {
        var _this = this;
                        ...
                        actionButtons: [
                            {
                                ...
                                buttonClass: 'btn btn-success',
                                onAction: function () {
                                    _this.http.put('/api/slide/deletes', data_1, _this.httpOptions).subscribe(function (res) {
                                        if (res["meta"]["error_code"] == 200) {
                                            _this.toastSuccess("Xóa thành công!");
                                            _this.GetListSlide();
    ...
    SlideComponent.prototype.closeNoityfy = function () {
        this.isNoitify = true;
    };
    SlideComponent.prototype.OpenMediaModal = function () {
        this.OpenMediaFile.show();
    };
    SlideComponent.prototype.CloseMediaModal = function () {
        this.OpenMediaFile.hide();
    };
    SlideComponent.prototype.tabHandleMedia = function () {
        this.isActiveMedia = true;
        this.isActiveUpload = false;
    };
    SlideComponent.prototype.tabHandleMediaUpload = function () {
        this.isActiveMedia = false;
        this.isActiveUpload = true;
    };
    SlideComponent.prototype.upload3 = function (files, cs) {
        var _this = this;
        if (files.length === 0)
            return;
        var formData = new FormData();
    ...
    SlideComponent.prototype.RemoveImageAvatar = function () {
        this.Item.Image = undefined;
        this.file.nativeElement.value = "";
        this.message = undefined;
        this.progress = undefined;
    };
    SlideComponent.prototype.loadMore = function () {
        var _this = this;
        this.isDelay = true;
        setTimeout(function () {
            _this.isDelay = false;
    ...
    SlideComponent.prototype.GetListFiles = function () {
        var _this = this;
    ...
    SlideComponent.prototype.SeclectMedia = function (item) {
    ...
    __decorate([
        ...
        __metadata("design:type", modal_1.ModalDirective)
    ], SlideComponent.prototype, "OpenMediaFile", void 0);
