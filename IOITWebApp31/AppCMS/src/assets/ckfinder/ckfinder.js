                ...
                function u(e, t, n, r) {
                    ...
                    if (e.length) {
                        ...
                        if (r.util.asyncArrayTraverse(e, function (e) {
                            ...
                            b['msg'] = 'The number of files per folder after the upload cannot exceed 10 in demo mode1111.', C + l.length > '10000' && r.request('dialog:info', b);
                            var x = -(C - '10000');
                        ...
                        'settings:define': function (t) {
                            ...
                            return function () {
                                ...
                                function i() {
                                    h = !0;
                                    var t = {};
                                    t['message'] = 'CNTT Việt Nam', e.request('page:showInRegion', {
