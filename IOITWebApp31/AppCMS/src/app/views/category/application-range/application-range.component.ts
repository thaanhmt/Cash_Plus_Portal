...
export class ApplicationRangeComponent implements OnInit, OnDestroy {
  ...
  GetListCateParent(Id) {
    this.http.get('/api/category/GetByTree?arr=15&langId=' + this.Item.LanguageId, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
