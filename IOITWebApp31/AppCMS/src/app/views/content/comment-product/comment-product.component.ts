...
export class CommentProductComponent implements OnInit {
  ...
  GetListCommentPost() {
    this.page_pp = [];
    this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=TargetType=2&order_by=', this.httpOptions).subscribe(
      (res) => {
  ...
  GetListCommentPostChoDuyet() {
    this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=1&order_by=', this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetListCommentPostDaDuyet() {
    this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=2&order_by=', this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetListCommentPostKhongDuyet() {
    this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=3&order_by=', this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetListCommentPostSpam() {
    this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status=4&order_by=', this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetListNews() {
    this.http.get('/api/product/GetByPage?page=' + this.paging.page + '&query=' + this.paging.query + '&order_by=', this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  ChangeStatust(id) {
    if (id == 0) {
      ...
      this.http.get('/api/comment/GetByPage?page=' + this.paging.page + '&query=TargetType=2 AND Status =' + id + '&order_by=', this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            this.listCommentPost = res["data"];
            this.paging.item_count = res["metadata"];
