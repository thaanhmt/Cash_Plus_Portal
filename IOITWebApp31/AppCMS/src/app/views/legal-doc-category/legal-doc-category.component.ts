...
export class LegalDocCategoryComponent implements OnInit {
                ...
                (res) => {
                    if (res["meta"]["error_code"] == 200) {
                        ...
                        if (type == 3 || type == 6 || type==8) {
                            ...
                            if (this.listLanguage.length == res["data"].listLanguage.length + 1) {
                                this.toastWarning("Bạn đã thêm đủ ngôn ngữ!");
                                return;
                            }
                            this.listLanguageTemp = [];
                            this.Item.CategoryId = undefined;
                            this.Item.CategoryRootId = res["data"].CategoryId;
                            ...
                            for (var i = 0; i < this.listLanguage.length; i++) {
                                ...
                                if (res["data"].listLanguage.length > 0) {
                                    for (var j = 0; j < res["data"].listLanguage.length; j++) {
                                        if (this.listLanguage[i].LanguageId == res["data"].listLanguage[j].LanguageId2) {
                                            check = true;
                                            break;
                                        }
                                    }
