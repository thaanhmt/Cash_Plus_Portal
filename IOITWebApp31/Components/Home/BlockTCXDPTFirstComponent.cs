...
{
    [ViewComponent(Name = "BlockTCXDPTFirst")]
    public class BlockTCXDPTFirstComponent : ViewComponent
    {
        public BlockTCXDPTFirstComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCXDPTFirst", data));
            }
        }
