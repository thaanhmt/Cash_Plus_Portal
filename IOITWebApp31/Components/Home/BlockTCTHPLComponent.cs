...
{
    [ViewComponent(Name = "BlockTCTHPL")]
    public class BlockTCTHPLComponent : ViewComponent
    {
        public BlockTCTHPLComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCTHPL", data));
            }
        }
