...
{
    [ViewComponent(Name = "BlockTCVideos")]
    public class BlockTCVideosComponent : ViewComponent
    {
        public BlockTCVideosComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number, int Skip)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCVideos", data));
            }
        }
