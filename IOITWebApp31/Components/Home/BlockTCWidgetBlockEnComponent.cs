...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockTCWidgetBlockEn")]
    public class BlockTCWidgetBlockEnComponent : ViewComponent
    {
        public BlockTCWidgetBlockEnComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCWidgetBlockEn", data));
            }
        }
