...
{
    [ViewComponent(Name = "BlockTCFirstMostViewEn")]
    public class BlockTCFirstMostViewEnComponent : ViewComponent
    {
        public BlockTCFirstMostViewEnComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCFirstMostViewEn", data));
            }
        }
