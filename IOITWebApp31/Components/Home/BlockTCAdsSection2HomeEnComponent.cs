...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockTCAdsSection2HomeEn")]
    public class BlockTCAdsSection2HomeEnComponent : ViewComponent
    {
        public BlockTCAdsSection2HomeEnComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCAdsSection2HomeEn", data));
            }
        }
