...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockTCWidgetBlock")]
    public class BlockTCWidgetBlockComponent : ViewComponent
    {
        public BlockTCWidgetBlockComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCWidgetBlock", data));
            }
        }
