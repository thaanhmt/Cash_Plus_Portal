...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockDS_SliderHome")]
    public class BlockDS_SliderHomeComponent : ViewComponent
    {
        public BlockDS_SliderHomeComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int LanguageId)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockDS_SliderHome", data));
            }
        }
