...
{
    [ViewComponent(Name = "BlockTCMostViewEn")]
    public class BlockTCMostViewEnComponent : ViewComponent
    {
        public BlockTCMostViewEnComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCMostViewEn", data));
            }
        }
