...
{
    [ViewComponent(Name = "BlockTCTHPLFirst")]
    public class BlockTCTHPLFirstComponent : ViewComponent
    {
        public BlockTCTHPLFirstComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCTHPLFirst", data));
            }
        }
