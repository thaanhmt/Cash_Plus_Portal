...
{
    [ViewComponent(Name = "BlockDS_NewData")]
    public class BlockDS_NewDataComponent : ViewComponent
    {
        public BlockDS_NewDataComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                var data = await (from e in db.DataSet
                                  ...
                                  }).OrderByDescending(c => c.DateStartActive).Take(Number).ToListAsync();
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockDS_NewData", data));
            }
        }
