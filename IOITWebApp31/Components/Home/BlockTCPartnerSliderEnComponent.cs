...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockTCPartnerSliderEn")]
    public class BlockTCPartnerSliderEnComponent : ViewComponent
    {
        public BlockTCPartnerSliderEnComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCPartnerSliderEn", data));
            }
        }
