...
namespace IOITWebApp31.Components.Home
{
    ...
    [ViewComponent(Name = "BlockTCPartnerSlider")]
    public class BlockTCPartnerSliderComponent : ViewComponent
    {
        public BlockTCPartnerSliderComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCPartnerSlider", data));
            }
        }
