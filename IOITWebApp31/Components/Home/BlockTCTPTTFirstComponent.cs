...
{
    [ViewComponent(Name = "BlockTCTPTTFirst")]
    public class BlockTCTPTTFirstComponent : ViewComponent
    {
        public BlockTCTPTTFirstComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCTPTTFirst", data));
            }
        }
