...
{
    [ViewComponent(Name = "BlockNewsHomeMainRight")]
    public class BlockNewsHomeMainRightComponent : ViewComponent
    {
        public BlockNewsHomeMainRightComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockNewsHomeMainRight", data));
            }
        }
