...
{
    [ViewComponent(Name = "BlockTCNewsHomeSection1")]
    public class BlockTCNewsHomeSection1Component : ViewComponent
    {
        public BlockTCNewsHomeSection1Component()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCNewsHomeSection1", data));
            }
        }
