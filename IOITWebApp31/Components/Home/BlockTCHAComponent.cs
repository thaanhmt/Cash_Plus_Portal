...
{
    [ViewComponent(Name = "BlockTCHA")]
    public class BlockTCHAComponent : ViewComponent
    {
        public BlockTCHAComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCHA", data));
            }
        }
