...
{
    [ViewComponent(Name = "BlockTCBD")]
    public class BlockTCBDComponent : ViewComponent
    {
        public BlockTCBDComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCBD", data));
            }
        }
