...
{
    [ViewComponent(Name = "BlockTCPLQTFirst")]
    public class BlockTCPLQTFirstComponent : ViewComponent
    {
        public BlockTCPLQTFirstComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockTCPLQTFirst", data));
            }
        }
