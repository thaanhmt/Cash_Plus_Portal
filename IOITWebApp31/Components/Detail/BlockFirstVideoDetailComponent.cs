...
{
    [ViewComponent(Name = "BlockFirstVideoDetail")]
    public class BlockFirstVideoDetailComponent : ViewComponent
    {
        public BlockFirstVideoDetailComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int CategoryId)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockFirstVideoDetail", data));
            }
        }
