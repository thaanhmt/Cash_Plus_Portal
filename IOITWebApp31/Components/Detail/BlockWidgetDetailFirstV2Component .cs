...
{
    [ViewComponent(Name = "BlockWidgetDetailFirstV2")]
    public class BlockWidgetDetailFirstV2Component : ViewComponent
    {
        public BlockWidgetDetailFirstV2Component()
        {
        }
            ...
            using (var db = new IOITDataContext())
            {
                ...
                if (ParentId == 0)
                {
                    ...
                    if (DBFirstChilren != null)
                    {
                        ...
                        return await Task.FromResult((IViewComponentResult)View("BlockWidgetDetailFirstV2", data));
                    }
                    else
                    {
