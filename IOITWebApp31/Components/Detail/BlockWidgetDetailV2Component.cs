...
{
    [ViewComponent(Name = "BlockWidgetDetailV2")]
    public class BlockWidgetDetailV2Component : ViewComponent
    {
        public BlockWidgetDetailV2Component()
        {
        }
            ...
            using (var db = new IOITDataContext())
            {
                ...
                if (ParentId == 0)
                {
                    ...
                    if (DBFirstChilren != null)
                    {
                        ...
                        return await Task.FromResult((IViewComponentResult)View("BlockWidgetDetailV2", data));
                    }
                    else
                    {
