...
{
    [ViewComponent(Name = "HeaderLogin")]
    public class HeaderLoginComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("HeaderLogin", customerLogin));
            }
        }
    }
}
