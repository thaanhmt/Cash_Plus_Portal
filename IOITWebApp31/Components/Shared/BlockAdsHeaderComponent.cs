...
namespace IOITWebApp31.Components.Shared
{
    ...
    [ViewComponent(Name = "BlockAdsHeader")]
    public class BlockAdsHeaderComponent : ViewComponent
    {
        public BlockAdsHeaderComponent()
        {
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int Id, int Number)
        {
            using (var db = new IOITDataContext())
            {
                ...
                return await Task.FromResult((IViewComponentResult)View("BlockAdsHeader", data));
            }
        }
