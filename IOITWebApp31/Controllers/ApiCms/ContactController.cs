...
namespace IOITWebApp31.ApiCMS.Controllers
{
    ...
    public class ContactController : ControllerBase
    {
        ...
        private static string functionCode = "TTLH";
                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            if (data.ContactId > 0)
                            {
                                ...
                                action.ActionName = "Sửa liên hệ “" + data.Title + "”";
                                action.ActionType = (int)Const.ActionType.UPDATE;
                                action.TargetId = data.ContactId.ToString();
                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            if (data.ContactId > 0)
                            {
                                transaction.Commit();
                                Models.EF.Action action = new Models.EF.Action();
                                action.ActionName = "Thêm liên hệ “" + data.Title + "”";
                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            if (data.ContactId > 0)
                            {
                                transaction.Commit();
                                Models.EF.Action action = new Models.EF.Action();
                                action.ActionName = "Xoá liên hệ “" + data.Title + "”";
        ...
        //API xóa danh sách liên hệ
        [HttpPut("deletes")]
        public async Task<IActionResult> DeleteContacts([FromBody] int[] data)
        {
            DefaultResponse def = new DefaultResponse();
            //check role
            var identity = (ClaimsIdentity)User.Identity;
            ...
            try
            {
                ...
                using (var db = new IOITDataContext())
                {
                    ...
                    {
                        Contact contact = await db.Contact.FindAsync(data[i]);
                        ...
                        contact.Status = (int)Const.Status.DELETED;
                        db.Entry(contact).State = EntityState.Modified;

                        Models.EF.Action action = new Models.EF.Action();
                        action.ActionName = "Xoá liên hệ “" + contact.Title + "”";
                        action.ActionType = (int)Const.ActionType.DELETE;
                        action.TargetId = contact.ContactId.ToString();
                        action.TargetName = contact.Title;
                        action.CompanyId = companyId;
                        action.Logs = JsonConvert.SerializeObject(contact);
                        action.Time = 0;
                        action.Ipaddress = IpAddress();
                        action.Type = (int)Const.TypeAction.ACTION;
                        action.CreatedAt = DateTime.Now;
