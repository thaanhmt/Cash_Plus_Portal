...
namespace IOITWebApp31.ApiCMS.Controllers
{
    ...
    public class LanguageController : ControllerBase
    {
                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            if (data.LanguageId > 0)
                            {
                                ...
                                action.ActionName = "Sửa ngôn ngữ “" + data.Name + "”";
                                action.ActionType = (int)Const.ActionType.UPDATE;
                                action.TargetId = data.LanguageId.ToString();
            ...
            try
            {
                ...
                using (var db = new IOITDataContext())
                {
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        await db.Language.AddAsync(data);
                        ...
                        try
                        {
                            ...
                            if (data.LanguageId > 0)
                            {
                                transaction.Commit();
                                Models.EF.Action action = new Models.EF.Action();
                                action.ActionName = "Thêm ngôn ngữ “" + data.Name + "”";
                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            if (data.LanguageId > 0)
                            {
                                transaction.Commit();
                                Models.EF.Action action = new Models.EF.Action();
                                action.ActionName = "Xoá ngôn ngữ “" + data.Name + "”";
        ...
        //API xóa danh sách ngôn ngữ
        [HttpPut("deletes")]
        public async Task<IActionResult> DeleteLanguages([FromBody] int[] data)
        {
            DefaultResponse def = new DefaultResponse();
            //check role
            var identity = (ClaimsIdentity)User.Identity;
            ...
            try
            {
                ...
                using (var db = new IOITDataContext())
                {
                    ...
                    {
                        Language language = await db.Language.FindAsync(data[i]);
                        ...
                        language.Status = (int)Const.Status.DELETED;
                        db.Entry(language).State = EntityState.Modified;
                        Models.EF.Action action = new Models.EF.Action();
                        action.ActionName = "Xoá ngôn ngữ “" + language.Name + "”";
                        action.ActionType = (int)Const.ActionType.DELETE;
                        action.TargetId = language.LanguageId.ToString();
                        action.TargetName = language.Name;
                        action.CompanyId = companyId;
                        action.Logs = JsonConvert.SerializeObject(language);
                        action.Time = 0;
                        action.Ipaddress = IpAddress();
                        action.Type = (int)Const.TypeAction.ACTION;
                        action.CreatedAt = DateTime.Now;
