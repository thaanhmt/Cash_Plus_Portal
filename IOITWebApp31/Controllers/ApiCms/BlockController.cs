...
namespace IOITWebApp31.ApiCMS.Controllers
{
    ...
    public class BlockController : ControllerBase
    {
        ...
        //API xóa danh sách khối nội dung
        [HttpPut("deletes")]
        public async Task<IActionResult> DeleteBlocks([FromBody] int[] data)
        {
            DefaultResponse def = new DefaultResponse();
            //check role
            var identity = (ClaimsIdentity)User.Identity;
            ...
            try
            {
                ...
                using (var db = new IOITDataContext())
                {
                    ...
                    {
                        Block block = await db.Block.FindAsync(data[i]);
                        ...
                        block.Status = (int)Const.Status.DELETED;
